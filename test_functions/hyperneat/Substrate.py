...
from test_functions.hyperneat.Neuron import Neuron
...
class Substrate:
    ...
    def initialise_substrate(self, substrate_data, function_name):

        self.__initialise_neurons(substrate_data, function_name)
    ...
    def __initialise_neurons(self, substrate_data, function_name):

        y_axis = -1.0

        if function_name == "gl" or function_name == "r":

            n = Neuron(-1, (0.0, y_axis))
